...
public class HomePage {
    ...
    private By cartButtonWithQuantity = By.xpath("//span[@class='shopping_cart_badge']");
    ...
    private By allItemsLink = By.xpath("//a[text()='All Items']");
    ...
    @Description("Click on the name of the Sauce Labs Backpack product item")
    public void clickSauceLabsBackpack() {
        driver.findElement(sauceLabsBackpack).click();
    }

    @Description("Click \"ADD TO CART\" button on the Sauce Labs Backpack product item on the Home page")
    public void clickAddCartSauceLabsBackpackButton() {
        driver.findElement(addCartSauceLabsBackpackToCartButton).click();
    }

    @Description("Click \"Cart\" icon on the Home page")
    public void clickCartButton() {
        driver.findElement(cartButton).click();
    }

    @Description("Add all product items to cart by clicking \"ADD TO CART\" button near each product on the Home page")
    ...
    @Description("Click \"sidebar\" icon on the Home page")
    public void clickSideBarButton() {
        driver.findElement(sidebarButton).click();
    }

    @Description("Click \"All items\" button inside Sidebar")
    public void clickAllItemsButton() {
        driver.findElement(allItemsLink).click();
    }

    @Description("Click \"About\" button inside Sidebar")
    ...
    @Description("Click \"Logout\" button on the Home Page")
    public void clickLogoutButton() {
        driver.findElement(logoutLink).click();
    }

    @Description("Click \"Name A to Z\" button in the dropdown list to sort product items from A to Z by alphabetic")
    ...
    @Description("Click \"Name Z to A\" button in the dropdown list to sort product items from A to Z by alphabetic")
